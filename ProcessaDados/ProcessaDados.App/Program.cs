...
Log.Information("Aplicação iniciada: v1.2.3");
...
static Dictionary<Hero, string> populaDictionarySteamHeroParams()
{
    ...
    {
        // Personas
        { Hero.AntimagePersona1, "npc_dota_hero_antimage_persona1" },
        { Hero.CrystalMaidenPersona1, "npc_dota_hero_crystal_maiden_persona1" },
        { Hero.PudgePersona1, "npc_dota_hero_pudge_persona1" },
        { Hero.InvokerPersona1, "npc_dota_hero_invoker_persona1" },
        // Heróis
        ...
        { Hero.CentaurWarrunner, "npc_dota_hero_centaur" },
        ...
        { Hero.Doom, "npc_dota_hero_doom_bringer" },
        ...
        { Hero.NaturesProphet, "npc_dota_hero_furion" },
        ...
        { Hero.Magnus, "npc_dota_hero_magnataur" },
        ...
        { Hero.Necrophos, "npc_dota_hero_necrolyte" },
        { Hero.ShadowFiend, "npc_dota_hero_nevermore" },
        { Hero.NightStalker, "npc_dota_hero_night_stalker" },
        { Hero.NyxAssassin, "npc_dota_hero_nyx_assassin" },
        { Hero.OutworldDestroyer, "npc_dota_hero_obsidian_destroyer" },
        ...
        { Hero.Clockwerk, "npc_dota_hero_rattletrap" },
        ...
        { Hero.Timbersaw, "npc_dota_hero_shredder" },
        { Hero.Silencer, "npc_dota_hero_silencer" },
        { Hero.WraithKing, "npc_dota_hero_skeleton_king" },
        ...
        { Hero.TreantProtector, "npc_dota_hero_treant" },
        { Hero.TrollWarlord, "npc_dota_hero_troll_warlord" },
        { Hero.Tusk, "npc_dota_hero_tusk" },
        { Hero.Underlord, "npc_dota_hero_abyssal_underlord" },
        ...
        { Hero.Windranger, "npc_dota_hero_windrunner" },
        { Hero.WinterWyvern, "npc_dota_hero_winter_wyvern" },
        { Hero.Io, "npc_dota_hero_wisp" },
        { Hero.WitchDoctor, "npc_dota_hero_witch_doctor" },
        { Hero.Zeus, "npc_dota_hero_zuus" }
    };
}
